use crate::hittable::{
    BvhNode, ConstantMedium, Cuboid, Hittable, HittableList, RotateY, Translation, XYRect, XZRect,
    YZRect,
};
...
pub fn scene() -> HittableList {
    ...
    let light = DiffuseLight::new(Rc::new(SolidColor::new(Color::new(7.0, 7.0, 7.0))));
